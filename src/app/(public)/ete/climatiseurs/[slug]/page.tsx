...
const CONFIG: Record<string, EntreeConfig> = {
  ...
  '9000-btu': {
    ...
    description: 'Comparez les climatiseurs 9000 BTU en Tunisie. Idéal pour pièce jusqu\'à 12 m². Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'Idéal pour chambre ou bureau jusqu\'à 12 m² — comparez tous les modèles 9 000 BTU disponibles en Tunisie.',
    heroFrom: '#0C4A6E',
  },
  '12000-btu': {
    type: 'btu', valeur: '12000',
    titre: 'Climatiseur 12000 BTU Tunisie — Meilleurs prix 2026',
    description: 'Comparez les climatiseurs 12000 BTU en Tunisie. Idéal pour pièce de 12 à 18 m². Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'Idéal pour salon ou chambre de 12 à 18 m² — comparez tous les modèles 12 000 BTU disponibles en Tunisie.',
    heroFrom: '#0C4A6E',
  },
  '18000-btu': {
    type: 'btu', valeur: '18000',
    titre: 'Climatiseur 18000 BTU Tunisie — Meilleurs prix 2026',
    description: 'Comparez les climatiseurs 18000 BTU en Tunisie. Idéal pour pièce de 18 à 25 m². Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'Idéal pour grand salon ou espace de 18 à 25 m² — comparez tous les modèles 18 000 BTU disponibles en Tunisie.',
    heroFrom: '#0C4A6E',
  },
  '24000-btu': {
    ...
    intro: 'Idéal pour grande pièce ou open-space de 25 à 35 m² — comparez tous les modèles 24 000 BTU disponibles en Tunisie.',
    heroFrom: '#0C4A6E',
  },
  // ── MARQUES ────────────────────────────────────────────────────────────────
  'gree': {
    ...
    description: 'Comparez les prix des climatiseurs Gree en Tunisie. Split, inverter, chaud/froid. Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'Gree, leader mondial de la climatisation — comparez tous les modèles split et inverter disponibles en Tunisie.',
    heroFrom: '#064E3B',
  },
  'midea': {
    type: 'marque', valeur: 'midea',
    titre: 'Climatiseur Midea Tunisie — Meilleurs prix 2026',
    description: 'Comparez les prix des climatiseurs Midea en Tunisie. Split, inverter, chaud/froid. Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'Midea, qualité et fiabilité reconnues — comparez tous les modèles split et inverter disponibles en Tunisie.',
    heroFrom: '#1E3A5F',
  },
  'saba': {
    type: 'marque', valeur: 'saba',
    titre: 'Climatiseur SABA Tunisie — Meilleurs prix 2026',
    description: 'Comparez les prix des climatiseurs SABA en Tunisie. Split, inverter, chaud/froid. Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'SABA, marque économique et accessible — comparez tous les modèles split et inverter disponibles en Tunisie.',
    heroFrom: '#312E81',
  },
  'condor': {
    type: 'marque', valeur: 'condor',
    titre: 'Climatiseur Condor Tunisie — Meilleurs prix 2026',
    description: 'Comparez les prix des climatiseurs Condor en Tunisie. Split, inverter, chaud/froid. Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'Condor, marque robuste et populaire — comparez tous les modèles split et inverter disponibles en Tunisie.',
    heroFrom: '#7C2D12',
  },
  'biolux': {
    type: 'marque', valeur: 'biolux',
    titre: 'Climatiseur Biolux Tunisie — Meilleurs prix 2026',
    description: 'Comparez les prix des climatiseurs Biolux en Tunisie. Split, inverter, chaud/froid. Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'Biolux, marque tunisienne accessible — comparez tous les modèles split et inverter disponibles en Tunisie.',
    heroFrom: '#14532D',
  },
  'lg': {
    type: 'marque', valeur: 'lg',
    titre: 'Climatiseur LG Tunisie — Meilleurs prix 2026',
    description: 'Comparez les prix des climatiseurs LG en Tunisie. Dual Inverter, WiFi, chaud/froid. Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'LG Dual Inverter — technologie éprouvée et économie d\'énergie. Comparez tous les modèles disponibles en Tunisie.',
    heroFrom: '#1E1B4B',
  },
  'tcl': {
    type: 'marque', valeur: 'tcl',
    titre: 'Climatiseur TCL Tunisie — Meilleurs prix 2026',
    description: 'Comparez les prix des climatiseurs TCL en Tunisie. Split, inverter, WiFi. Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'TCL, rapport qualité-prix imbattable — comparez tous les modèles split et inverter disponibles en Tunisie.',
    heroFrom: '#0C4A6E',
  },
  'samsung': {
    type: 'marque', valeur: 'samsung',
    titre: 'Climatiseur Samsung Tunisie — Meilleurs prix 2026',
    description: 'Comparez les prix des climatiseurs Samsung en Tunisie. WindFree, inverter, WiFi. Meilleures offres chez Mytek, Tunisianet et Spacenet.',
    intro: 'Samsung WindFree — confort silencieux et connectivité WiFi. Comparez tous les modèles disponibles en Tunisie.',
    heroFrom: '#1E3A5F',
  },
  'cristor': {
    ...
    intro: 'Cristor, marque économique et fiable — comparez tous les modèles split et inverter disponibles en Tunisie.',
    heroFrom: '#064E3B',
  },
}
